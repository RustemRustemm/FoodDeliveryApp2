...
private extension OnboardingViewController {
    ...
    func setupPageViewController() {
        ...
        pageViewController.setViewControllers([pages.first!], direction: .forward, animated: true, completion: .none)
    ...
    func setupButton() {
        ...
        bottomButton.titleLabel?.font = UIFont.Roboto.bold.size(of: 18)
//        bottomButton.titleLabel?.textColor = AppColors.black
        ...
        NSLayoutConstraint.activate([
//            bottomButton.topAnchor.constraint(equalTo: descriptionLabel.bottomAnchor, constant: 44),
            bottomButton.topAnchor.constraint(equalTo: pageControl.bottomAnchor, constant: -88),
            bottomButton.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            bottomButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 30),
            bottomButton.leadingAnchor.constraint(equalTo: view.trailingAnchor, constant: -30),
